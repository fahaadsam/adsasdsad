...
$('.TitleForm').submit(function(){
	var urlat = window.location.pathname.split('/');
	var serializedData = $('.TitleForm').serialize();
	serializedData = serializedData+'&titlename='+ titleVal +'&id=' + titleId +'&UrlParameter='+urlat[2]+'&UrlPage='+urlat[3];
	$.ajax({
		url : BASEURL + "Template/FormsContent" ,
		type : "POST",
		data: serializedData,
